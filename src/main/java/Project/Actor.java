...
public class Actor extends Repository {
    ...
    void check() {
        try {
            ...
            String sql = "select * from searchword.actorsearchword where searchword = '" + str + "';";
            ...
            if (rs.next()) {
                ...
                count = count + 1;
                String sql3 = "update searchword.actorsearchword set count = " + count + " where searchword = '" + str + "';";
                state = (Statement) conn.createStatement();
                state.executeUpdate(sql3);
            } else {
                int num = 1;
                String sql4 = "insert into searchword.actorsearchword (searchword,count) values('" + str + "'," + num + ")";
                state = (Statement) conn.createStatement();
